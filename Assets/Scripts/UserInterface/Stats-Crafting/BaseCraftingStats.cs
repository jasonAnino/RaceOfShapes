...
namespace UnitStats
{
    /// <summary>
    ///  CRAFTING STATS
    ///  Level - Higher Level, increases chance of Perfect Item by 0.0001%;
    /// </summary>
    [Serializable]
    public class BaseCraftingStats
    {

        CraftingStats statName;
        ...
        public List<NumericalStatsHolder> numStatsHolder;

        public void InitializeStats(CraftingStats newName, int newLevel = 1, float newExpProgress = 0)
        {
            statName = newName;
            statLevel = newLevel;
